...
export function createUnbakePanel(el, {
    ...
    downloadButton.addEventListener('click', (event) => {
        ...
        /*
         * **構えているときは、その返事を受ける**（2026-08-28 利用者の報告
         * 「ここから先に進めません」）。
         *
         * モデルは2回押しで落とす形（1回目に顔ぶれを見せ、2回目で走る）。
         * 品書きへ畳んだとき**この釦の押しを品書きに取られた**ので、
         * 「本当にダウンロード（N 件・サイズ）」と書いてあるのに、押すと
         * 品書きが開くだけになっていた——**2回目の押しがどこにも無い。**
         */
        if (armedDownload) { downloadMissing(); return; }
